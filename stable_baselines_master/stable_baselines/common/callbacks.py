...
from stable_baselines_master.stable_baselines.common.vec_env import VecEnv, sync_envs_normalization, DummyVecEnv
...
if typing.TYPE_CHECKING:
    from stable_baselines_master.stable_baselines.common.base_class import BaseRLModel  # pytype: disable=pyi-error
