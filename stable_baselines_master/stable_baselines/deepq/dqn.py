...
from stable_baselines_master.stable_baselines.common.buffers import ReplayBuffer, PrioritizedReplayBuffer
from stable_baselines_master.stable_baselines.deepq.build_graph import build_train
from stable_baselines_master.stable_baselines.deepq.policies import DQNPolicy


class DQN_model(OffPolicyRLModel):
    """
    The DQN model class.
    ...
    def __init__(self, policy, env, gamma=0.99, learning_rate=5e-4, buffer_size=50000, exploration_fraction=0.1,
        ...
        super(DQN_model, self).__init__(policy=policy, env=env, replay_buffer=None, verbose=verbose, policy_base=DQNPolicy,
    ...
    def learn(self, total_timesteps, save_path, callback=None, log_interval=100, tb_log_name="DQN",
        ...
        with SetVerbosity(self.verbose), TensorboardWriter(self.graph, self.tensorboard_log, tb_log_name, new_tb_log) \
            ...
            print('self total timesteps: ', total_timesteps)
            ...
            for _ in range(total_timesteps):
                ...
                if done:
                    print('current step: ', episode_step)
                    episode_step = 0
